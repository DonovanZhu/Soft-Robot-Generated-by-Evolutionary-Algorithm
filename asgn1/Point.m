fitness1 = load('HillClimber1.txt')/1000;
fitness2 = load('HillClimber2.txt')/1000;
fitness3 = load('HillClimber3.txt')/1000;
fitness4 = load('HillClimber4.txt')/1000;
fitness5 = load('HillClimber5.txt')/1000;
generation = 1:100000;
...
y7 = mean(G)
hold on;
errorbar(12500,y1,x1/sqrt(5),'r');
% errorbar(25000,y2,x2/sqrt(5),'r');
% errorbar(37500,y3,x3/sqrt(5),'r');
% errorbar(50000,y4,x4/sqrt(5),'r');
% errorbar(62500,y5,x5/sqrt(5),'r');
% errorbar(75000,y6,x6/sqrt(5),'r');
% errorbar(87500,y7,x7/sqrt(5),'r');
% hold on
