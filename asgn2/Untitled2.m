fitness1 = load('fitness1.txt')-0.05;
fitness2 = load('fitness2.txt')-0.05;
fitness3 = load('fitness3.txt')-0.05;
fitness4 = load('fitness4.txt')-0.05;
fitness5 = load('fitness5.txt')-0.05;
...
y7 = mean(G)
hold on;
errorbar(12500,y1,x1/sqrt(5),'b');
errorbar(25000,y2,x2/sqrt(5),'b');
errorbar(37500,y3,x3/sqrt(5),'b');
errorbar(50000,y4,x4/sqrt(5),'b');
errorbar(62500,y5,x5/sqrt(5),'b');
errorbar(75000,y6,x6/sqrt(5),'b');
errorbar(87500,y7,x7/sqrt(5),'b');
hold on
